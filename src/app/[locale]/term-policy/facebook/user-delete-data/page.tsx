...
// term-policy/facebook/user-delete-data
const user_delete_data = () => {
	return (
		<>
			<div className="data-deletion-container bg-gray-900 text-gray-200 mx-auto mt-8 max-w-3xl rounded-lg p-8 shadow-lg">
				<h1 className="my-4 text-xl font-semibold">User Data Deletion</h1>
				<p className="mb-4">
